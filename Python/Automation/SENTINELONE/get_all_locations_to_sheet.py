...
success = False
title = "NinjaOne Locations List Export"
content = "NinjaOne Locations List Export has completed successfully."
targetGroup = 2
worksheetIndex = 1
sheetIndex = 84
...
def main(sendMsg=False):
    try:
        ...
        print(f"An error occurred getting locations: {err}")
        return
