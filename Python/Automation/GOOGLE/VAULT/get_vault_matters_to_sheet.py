...
### LOCAL IMPORTS ###
import GOOGLE.WORKSPACE._functions as fxns

success = False
title = "Google Vault Export"
content = "Google Vault Export has completed successfully."
targetGroup = 2
worksheetIndex = 1
sheetIndex = 8
...
def task():
    return fxns.run_gam_command(f'gam print vaultmatters basic')
