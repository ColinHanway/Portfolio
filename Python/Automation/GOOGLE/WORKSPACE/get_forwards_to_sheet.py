...
success = False
title = "Google Forwards Export"
content = "Google Forwards Export has completed successfully."
targetGroup = 2
worksheetIndex = 1
sheetIndex = 4
...
def task():
    command = 'gam all users print forwards enabledonly'
    return fxns.run_gam_command(command)
