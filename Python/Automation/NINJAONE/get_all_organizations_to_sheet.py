...
success = False
title = "NinjaOne Organizations List Export"
content = "NinjaOne Organizations List Export has completed successfully."
targetGroup = 2
worksheetIndex = 1
sheetIndex = 83
...
def task():
    return fxns.get_all_organizations()
...
def main(sendMsg=False):
    try:
        ...
        print(f"An error occurred getting organizations: {err}")
        return
